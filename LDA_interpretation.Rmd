...
setwd("/Users/Jann/Desktop/LMU_WISO/3. Semester/survival/LDA_interpretation/")
...
* NOTE: Constant contributions to time-varying can be interpreted as effects at t=0 \textcolor{red}{DISCUSS THIS}
...
This is the effect estimated for the smooth terms. The total effect of x at time point t = $\beta_x * x + f_x(t)$ where $\beta_x * x$ are the constant effects from the previous graphic and $f_x(t)$ models the effect of the smooth time varying term. They look like that:
